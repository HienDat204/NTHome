...
export const metadata = {
  title: "Admin Dashboard | Kiên Hưng Group",
};
    ...
    <div className="container mx-auto px-6 py-10">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Tổng quan số liệu quản trị và truy cập các chức năng nhanh.
          </p>
        </div>
        <Link
          href="/admin/properties"
          className="rounded-full bg-secondary px-5 py-3 text-sm font-semibold text-white hover:bg-blue-600"
        >
      ...
      <div className="grid gap-6 md:grid-cols-4">
        {Object.entries(stats).map(([key, value]) => (
          <div
            key={key}
            className="rounded-3xl bg-white p-6 shadow-lg shadow-slate-200/50"
          >
